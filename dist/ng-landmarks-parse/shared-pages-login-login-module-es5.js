(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["shared-pages-login-login-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_store_actions_auth_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/store/actions/auth.actions */ "./src/store/actions/auth.actions.ts");
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(authService, formBuilder, router, toastService, store) {
                ...
                LoginComponent.prototype.onSubmit = function (value) {
                    ...
                    this.authService.login(value.username, value.password).then(function (user) {
                        _this.store.dispatch(new src_store_actions_auth_actions__WEBPACK_IMPORTED_MODULE_7__["AuthLoggedInAction"]());
                        _this.toastService.show("Welcome " + user.getUsername() + "!", { classname: 'bg-success text-light', delay: 1000 });
                        _this.router.navigate(['/home']);
                    }).catch(function (error) {
                        _this.store.dispatch(new src_store_actions_auth_actions__WEBPACK_IMPORTED_MODULE_7__["AuthLoggedOutAction"]());
