(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavbarComponent = /** @class */ (function () {
                function NavbarComponent(authService, store) {
                    this.authService = authService;
                    this.store = store;
                    // TO-DO
                ...
                NavbarComponent.prototype.ngOnInit = function () {
                    ...
                    this.auth = this.store.select(function (state) { return state.auth; });
                    this.auth.subscribe(function (s) { return console.log(s.isLogged); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGaurd = /** @class */ (function () {
                function AuthGaurd(authService, router, store) {
                    this.authService = authService;
                    this.router = router;
                    this.store = store;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginGuard = /** @class */ (function () {
                function LoginGuard(authService, router, store) {
                    this.authService = authService;
                    this.router = router;
                    this.store = store;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                function AuthService(router, toasterService, store) {
                    this.router = router;
                ...
                AuthService.prototype.login = function (username, password) {
                    ...
                    return new Promise(function (resolve, reject) {
                        parse__WEBPACK_IMPORTED_MODULE_2__["User"].logIn(username, password).then(function (user) {
                            ...
                            _this.store.dispatch(new src_store_actions_auth_actions__WEBPACK_IMPORTED_MODULE_6__["AuthLoggedInAction"]());
                            resolve(user);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LandmarkService = /** @class */ (function () {
                function LandmarkService(toastService, http) {
                    this.toastService = toastService;
                    this.http = http;
                }
                ...
                LandmarkService.prototype.isFileSizeAccepted = function (fileSize) {
                ...
                LandmarkService.prototype.showError = function (message, error) {
                    if (error) {
                 ...
                 * @param sessionToken
                 */
                LandmarkService.prototype.createTumbnail = function (landmarkId, photoUrl, sessionToken) {
                    var _this = this;
                    return new Promise(function (resolve, reject) {
                        var body = {
                        ...
                        _this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverURL + "/functions/thumbnail", body, { headers: headers }).subscribe(function (data) {
                            resolve(data);
                        }, function (error) {
                            reject(error);
                        });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthLoggedInAction = /** @class */ (function () {
                function AuthLoggedInAction() {
                    this.type = AuthActionTypes.LOGGED_IN;
                }
                return AuthLoggedInAction;
            }());
            var AuthLoggedOutAction = /** @class */ (function () {
                function AuthLoggedOutAction() {
                    this.type = AuthActionTypes.LOGGED_OUT;
                }
                return AuthLoggedOutAction;
            }());
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var initialState = { isLogged: false };
