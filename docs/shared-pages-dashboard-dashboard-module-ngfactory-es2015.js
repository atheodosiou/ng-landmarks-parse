...
class DashboardComponent {
    ...
    onSubmit(value) {
        ...
        if (this.photoToBeUploaded && this.selectedLandmark) {
            ...
            let photo = new parse__WEBPACK_IMPORTED_MODULE_4__["File"](uuid_v4__WEBPACK_IMPORTED_MODULE_5__(), this.photoToBeUploaded);
